...
public class AnimatedSprite extends Sprite {
    ...
    private URL getURL(String filename) {
        ...
        try {
            ...
            System.out.println("dentro do metodo url: "+getClass().getResource(filename));
        }
        catch (Exception e) {
        ...
        int width, int height)
    {
        ...
        System.out.println("com url: "+getURL(filename));
        //animimage = tk.getImage(filename);	//funciona, mas nao carrega a imagem
        System.out.println("image tk: "+tk.getImage(getURL(filename)));
